...
export const soundLocations: SoundLocation[] = [
    ...
    },
    {
        ...
        description: 'At 140 Marcella St, the soundscape exists between Highland Park\'s interior neighborhood (farther upon the hill) and the heavy traffic of Columbus Avenue as it is the lowest street in Highland beyond Centre St. This recording captures a constant sonic underlay (almost muffled sounding) of passing cars and hum from HVAC systems, integrated with the faint bird calls of upper Highland, embodying a mixture of the typical soundscapes of residential blocks that border major transit routes in Boston. This recording further reflects Trudeau\'s research on the uneven distribution of urban noise, as communities near corridors that are highly used experience continuous, low-level exposure to urban noise every day. On Marcella St, the neighborhood meets the sonic pressures of the transit infrastructure in such close proximity, reflecting how even streets in neighborhood considered to be "quiet" reveal the patterns of infrastructural planning and mobility within Boston.',
    ...
    },
    {
        ...
        description: 'At the Jackson Square T Stop, the soundscape reflects the noises of transit through the rumble of buses, metal, idling engines, and the flux of citizens moving throughout the station. Arregi notes how transportation and "road traffic noise stands out as a significant factor contributing to widespread public health issues," functioning as one of the most persistent noise exposures and environmental stressors for citizens of urban areas (Arregi Abstract). At Jackson Square, where Boston citizens are housed in apartments above the corridor, the noise exposure to transportation is continuous both through traffic and transit (bus and train). The audio from the Jackson Square T sound walk captures simultaneously how the infrastructure designed for mobility through public transit can also place a physiological burden on citizens who live in immediate proximity to noise. In Roxbury, decades of urban planning have concentrated the transit corridors through working neighborhoods, which further reflects who is subjected to the noises of city transportation and access to restorative sonic escape through its soundscape.',
